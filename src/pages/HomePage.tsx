  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section 
        ...
        style={{ backgroundImage: `url(https://images.pexels.com/photos/2702805/pexels-photo-2702805.jpeg)` }}
      >
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link 
                to="/food"
                className="bg-[#7D0633] hover:bg-[#9A1750] text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 text-center flex items-center justify-center gap-2"
              >
                <Utensils size={20} />
                Food Pairings
              </Link>
              ...
              <Link 
                to="/occasion"
                className="bg-[#D4AF37] hover:bg-[#F0C551] text-gray-900 font-bold py-3 px-6 rounded-lg transition-colors duration-300 text-center flex items-center justify-center gap-2"
              >
                <Calendar size={20} />
                Occasions
              </Link>
      ...
      <section className="py-16 bg-[#F5F5F5]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold text-center text-[#1B512D] mb-12">
            How It Works
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <div className="w-16 h-16 bg-[#7D0633] rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative overflow-hidden rounded-xl shadow-lg group">
              ...
              <div className="absolute bottom-0 p-6">
                ...
                <Link 
                  to="/food"
                  className="inline-block bg-[#D4AF37] hover:bg-[#F0C551] text-gray-900 font-bold py-2 px-4 rounded-lg transition-colors duration-300"
                >
